...
exports.deleteBrandById = (req, res) => {
    Brand.deleteBrandById(req.params.brandId, (err, data) => {
        if (err){
            res.status(500).send({
             message:
               err.message || "Some error occurred while retrieving Brand. [getBrandById]"
...
exports.createSlide = (req, res) => {
    // console.log('29 sep => ', req)
    Brand.createSlide(req, (err, data) => {
        if (err){
            res.status(500).send({
             message:
               err.message || "Some error occurred while creating Brand. [getBrandById]"
...
exports.syncPic = (req, res) => {
    // console.log('29 sep => ', req)
    Brand.syncPic(req, (err, data) => {
        if (err){
            res.status(500).send({
             message:
               err.message || "Some error occurred while creating Brand. [getBrandById]"
...
exports.updateSlideOrder = (req, res) => {
    // console.log('29 sep => ', req)
    Brand.updateSlideOrder(req, (err, data) => {
        if (err){
            res.status(500).send({
             message:
               err.message || "Some error occurred while creating Brand. [getBrandById]"
...
exports.deleteSlide = (req, res) => {
    // console.log('29 sep => ', req)
    Brand.deleteSlide(req, (err, data) => {
        if (err){
            res.status(500).send({
             message:
               err.message || "Some error occurred while creating Brand. [getBrandById]"
